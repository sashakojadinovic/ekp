        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="d-flex justify-content-between">
                    <div>
                        <a class="btn btn-outline-dark" href="/authors"><i class="bi bi-arrow-90deg-up"> </i>Spisak autora</a>
                    </div>
                    <div>
                        <a class="btn btn-outline-dark mx-1 d-inline-block" href="/authors/{{ $author->id }}/edit"><i
