...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h1 class="mt-3 text-center">Dodaj blog</h1>
                @if(session("success"))
                ...
                <form action="/blogs" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-2">
                        ...
                        <input class="form-control bg-white rounded-pill" type="text" name="title" id="blog-title">
                    </div>
                    <div class="my-2">
                        <label class="form-label" for="blog-short-desc">Kratak opis</label>
                        <input class="form-control bg-white rounded-pill" type="text" name="short_desc" id="blog-short-desc">
                    </div>
                    <div class="my-2">
                        <label class="form-label" for="blog-short-desc">Tekst</label>
                        <textarea class="ckeditor form-control bg-white rounded-pill" id="desc" name="desc"></textarea>
