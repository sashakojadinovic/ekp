...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h1 class="mt-3 text-center">Izmeni informacije o izdavaču</h1>
                ...
                <form action="/publishers/{{$publisher->id}}" method="POST">
                    ...
                    <input class="form-control bg-white rounded-pill" value="{{$publisher->name}}" type="text" name="name" id="publisher-name">
                    </div class="my-2">
                    <div>
                    ...
                    <textarea class="form-control bg-white" name="info" id="publisher-info" cols="30"
                        rows="10">{{$publisher->info}}</textarea>
                    </div>

                    <div class="d-flex justify-content-end">
                    <a href="/publishers/{{$publisher->id}}" class="btn btn-outline-dark rounded-pill  mt-2"><i class="bi bi-x-circle"> </i> Odustani</a>
