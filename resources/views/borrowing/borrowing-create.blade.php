                ...
                <form action="/authors" method="POST">
                    ...
                    <div class="my-2">
                        ...
                        <div class="row">
                            ...
                            <div class="my-2 col-md-6">
                                <label class="form-label" for="reader-name">Ime autora</label>
                                <input class="form-control bg-white rounded-pill" type="text" name="reader_name" id="reader-name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="/authors" class="btn btn-outline-dark rounded-pill  mt-2"><i class="bi bi-x-circle"> </i>
                            Odustani</a>
