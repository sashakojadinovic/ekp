        ...
        <div class="row justify-content-center">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Da li ste sigurni da želite da izbrišete donatora?</p>
                        </div>
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between">
                    <div>
                        <a class="btn btn-dark rounded-pill" href="/donators"><i class="bi bi-arrow-90deg-up"> </i>Lista donatora</a>
                    </div>
                    <div>
                        <a class="btn btn-success rounded-pill mx-1 d-inline-block" href="/donators/{{ $donator->id }}/edit"><i
