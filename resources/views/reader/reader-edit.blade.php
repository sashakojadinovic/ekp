...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h1 class="mt-3 text-center">Izmeni podatke</h1>
                ...
                <form action="/readers/{{$reader->id}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="my-2 col-md-3">
                            ...
                            <select class="form-select bg-white rounded-pill" name="gender" id="reader-gender">
                                <option {{$reader->gender===-1?'selected':null}} value="-1" selected>Odaberite pol</option>
                    ...
                    <div class="row">
                        ...
                        <div class="my-2 col-md-3">
                            ...
                            <input value="{{$reader->date_of_birth}}" class="form-control bg-white rounded-pill" type="date" name="date_of_birth" id="date-of-birth">
                        </div>
                        <div class="my-2 col-md-6">
                            <label class="form-label" for="parents-name">Ime roditelja (za decu)</label>
                            <input value="{{$reader->parents_name}}" class="form-control bg-white rounded-pill" type="text" name="parents_name" id="parents-name">
                        </div>
                    </div>
                    <div class="row">
                        <div class="my-2 col-md-6">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="/readers/{{$reader->id}}" class="btn btn-secondary rounded-pill  mt-2"><i class="bi bi-x-circle"> </i>Odustani </a>
