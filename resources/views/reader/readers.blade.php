                    ...
                    <tbody>
                        @foreach ($readers as $reader)
                            <tr>
                                ...
                                <td><a class="{{count($reader->borrowing()->get())>0?'btn btn-sm btn-danger rounded-pill':'text-decoration-none'}}" href="/readers/{{$reader->id}}">{{ count($reader->borrowing()->get())>0?count($reader->borrowing()->get()):'nema' }}</a></td>
