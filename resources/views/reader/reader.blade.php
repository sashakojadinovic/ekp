        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                <div class="d-flex justify-content-between">
                    <div>
                        <a class="btn btn-outline-dark" href="/readers"><i class="bi bi-arrow-90deg-up"> </i>Spisak čitalaca</a>
                    </div>
                    <div>
                        <a class="btn btn-outline-dark mx-1 d-inline-block" href="/readers/{{ $reader->id }}/edit"><i
