        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between">
                    <div>
                        <a class="btn btn-dark rounded-pill" href="/locations"><i class="bi bi-arrow-90deg-up"> </i>Sve lokacije</a>
                    </div>
                    <div>
                        <a class="btn btn-success rounded-pill mx-1 d-inline-block" href="/locations/{{ $location->id }}/edit"><i
